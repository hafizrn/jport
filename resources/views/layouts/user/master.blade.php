					...
					<nav class="navbar navbar-expand-lg cp-nav-2">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav">
								...
								<li class="menu-item post-job"><a href="{{ route('user.resume.index') }}"><i class="fas fa-plus"></i>Post Resume</a></li>
							</ul>
						</div>
					</nav>
				</div>
						...
						<div class="dashboard-sidebar">
							...
							<div class="dashboard-menu">
								<ul>
									...
									<li><i class="fas fa-file-alt"></i><a href="{{route('user.resume.index')}}">Resume</a></li>
									
									<li><i class="fas fa-check-square"></i><a href="{{route('user.jobapply.index')}}">Applied Job</a></li>
